...
HYDRA_CONFIG_ROOT="${PROJECT_ROOT}/model5/configs/hydra"
cd "${BACKEND_ROOT}"
...
FUTURE_FEATURE_LATENT_SLOTS="${FUTURE_FEATURE_LATENT_SLOTS:-8}"
...
echo "[launch] model_package=${PROJECT_ROOT}/model5"
