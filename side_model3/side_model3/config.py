"""Typed, suite-agnostic configuration for the Side-Model3 v1 method."""
...
@dataclass(frozen=True)
class SideModel3Config:
    track_id: str = "side_model3"
    method_id: str = METHOD_ID
    runtime_package: str = "side_model3"
...
def config_from_dict(raw: dict[str, Any]) -> SideModel3Config:
...
def load_config(path: str | Path) -> SideModel3Config:
...
def config_dict(config: SideModel3Config) -> dict[str, Any]:
