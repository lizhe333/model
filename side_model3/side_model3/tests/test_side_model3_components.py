"""Focused CPU contracts for the Side-Model3 v1 components."""
...
from side_model3.models.action_dit import SideModel3ActionDiT
...
from side_model3.models.ladder_side_encoder import (
    LadderSideEncoder,
    O2StyleTraceFusion,
)
...
from side_model3.models.visual_anchor_resampler import VisualAnchorActionFusion
...
def test_ladder_gate_trace_shape_and_frozen_wan_boundary() -> None:
    torch.manual_seed(1)
