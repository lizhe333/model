"""Typed, suite-agnostic configuration for copied Side-Model3-Adapter v1."""
...
HYDRA_MODEL = "side_model3_adapter_v1"
...
@dataclass(frozen=True)
class SideModel3AdapterConfig:
    track_id: str = "side_model3_adapter"
    method_id: str = METHOD_ID
    runtime_package: str = "side_model3_adapter"
...
def default_config() -> SideModel3AdapterConfig:
    """Return the frozen method contract without selecting a dataset or suite."""

    return SideModel3AdapterConfig()
...
def config_from_dict(raw: dict[str, Any]) -> SideModel3AdapterConfig:
...
def load_config(path: str | Path) -> SideModel3AdapterConfig:
...
def config_dict(config: SideModel3AdapterConfig) -> dict[str, Any]:
